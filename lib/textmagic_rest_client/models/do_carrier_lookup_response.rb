...
module TextMagic
  class DoCarrierLookupResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'number164')
        self.number164 = attributes[:'number164']
      end
    ...
    def list_invalid_properties
      ...
      if @local.nil?
        invalid_properties.push('invalid value for "local", local cannot be nil.')
      end
      ...
      if @number164.nil?
        invalid_properties.push('invalid value for "number164", number164 cannot be nil.')
      end
    ...
    def hash
      [cost, country, local, type, carrier, number164, valid].hash
    end
