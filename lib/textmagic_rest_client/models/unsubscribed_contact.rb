...
module TextMagic
  class UnsubscribedContact
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'unsubscribeTime')
        self.unsubscribe_time = attributes[:'unsubscribeTime']
      end
    ...
    def list_invalid_properties
      ...
      if @unsubscribe_time.nil?
        invalid_properties.push('invalid value for "unsubscribe_time", unsubscribe_time cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @unsubscribe_time.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          phone == o.phone &&
          unsubscribe_time == o.unsubscribe_time &&
    ...
    def hash
      [id, phone, unsubscribe_time, first_name, last_name].hash
    end
