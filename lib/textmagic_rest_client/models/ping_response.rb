...
module TextMagic
  class PingResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'utcDateTime')
        self.utc_date_time = attributes[:'utcDateTime']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @utc_date_time.nil?
        invalid_properties.push('invalid value for "utc_date_time", utc_date_time cannot be nil.')
      end
