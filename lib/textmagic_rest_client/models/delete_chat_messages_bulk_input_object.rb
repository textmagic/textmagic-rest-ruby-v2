...
module TextMagic
  class DeleteChatMessagesBulkInputObject
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'inbound_ids')
        self.inbound_ids = attributes[:'inbound_ids']
      end

      if attributes.has_key?(:'sent_ids')
        self.sent_ids = attributes[:'sent_ids']
      end

      if attributes.has_key?(:'calls_ids')
        self.calls_ids = attributes[:'calls_ids']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          inbound_ids == o.inbound_ids &&
          sent_ids == o.sent_ids &&
          calls_ids == o.calls_ids &&
          all == o.all
    end
    ...
    def hash
      [inbound_ids, sent_ids, calls_ids, all].hash
    end
