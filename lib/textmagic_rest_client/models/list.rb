...
module TextMagic
  class List
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'membersCount')
        self.members_count = attributes[:'membersCount']
      end
    ...
    def hash
      [id, name, description, favorited, members_count, user, service, shared, avatar, is_default].hash
    end
