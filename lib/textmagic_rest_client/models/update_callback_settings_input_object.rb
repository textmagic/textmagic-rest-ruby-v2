...
module TextMagic
  class UpdateCallbackSettingsInputObject
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'outUrl')
        self.out_url = attributes[:'outUrl']
      end

      if attributes.has_key?(:'inUrl')
        self.in_url = attributes[:'inUrl']
      end
    ...
    def format=(format)
      validator = EnumAttributeValidator.new('String', ['m', 'u', 'j'])
