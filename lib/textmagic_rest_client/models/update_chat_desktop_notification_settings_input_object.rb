...
module TextMagic
  class UpdateChatDesktopNotificationSettingsInputObject
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'playSound')
        self.play_sound = attributes[:'playSound']
      end

      if attributes.has_key?(:'showNotifications')
        self.show_notifications = attributes[:'showNotifications']
      end
      ...
      if attributes.has_key?(:'soundId')
        self.sound_id = attributes[:'soundId']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          show_notifications == o.show_notifications &&
    ...
    def hash
      [play_sound, show_notifications, show_text, sound_id].hash
    end
